...
\def\title{Integrationsszenarien zwischen lokalem Active Directory und Azure Active Directory}		% Titel der Arbeit
\def\titleFrontpage{Integrationsszenarien zwischen lokalem Active Directory und Azure Active Directory}
\def\doctype{Projektarbeit 2 (T2\_2000)}	% Art des Dokumentes, z.B. Studienarbeit, Bachelorarbeit, Bericht, ...
...
\def\bearbeitungsZeit{16 Wochen}			% Bearbeitsungszeitraum
\def\ausbildungsfirma{Deutsche Bundesbank} 	% Ausbildungsfirma
\def\betreuerFirma{Matthias Bergmann}		% Betreuer der Ausbildungsfirma
\def\betreuerDH{Edward Riewe}				% Betreuer der Dualen Hochschule
